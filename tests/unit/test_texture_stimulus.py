...
class TestGaborTexture:
    ...
    def test_oscillatory_pattern(self):
        ...
        xx, yy = torch.meshgrid(
            torch.linspace(-1, 1, 100), torch.linspace(-1, 1, 100), indexing="ij"
        )
    ...
    def test_orientation_rotates_pattern(self):
        ...
        vertical = gabor_texture(
            xx, yy, wavelength=0.3, orientation=math.pi / 2, sigma=1.0
        )
    ...
    def test_invalid_wavelength_raises_error(self):
        ...
        xx, yy = torch.meshgrid(
            torch.linspace(-1, 1, 16), torch.linspace(-1, 1, 16), indexing="ij"
        )
...
class TestEdgeGrating:
    ...
    def test_count_affects_number_of_edges(self):
        ...
        xx, yy = torch.meshgrid(
            torch.linspace(-3, 3, 200), torch.linspace(-3, 3, 200), indexing="ij"
        )
    ...
    def test_normalization(self):
        ...
        normalized = edge_grating(xx, yy, amplitude=amplitude, normalize=True)
        not_normalized = edge_grating(xx, yy, amplitude=amplitude, normalize=False)
...
class TestGaborTextureModule:
    ...
    def test_module_creation(self):
        ...
        module = GaborTexture(wavelength=0.5, orientation=math.pi / 4, sigma=0.3)
...
class TestEdgeGratingModule:
    ...
    def test_module_creation(self):
        """Test that module can be created with valid parameters."""
        module = EdgeGrating(orientation=math.pi / 6, spacing=0.5, count=10)
...
class TestTextureIntegration:
    ...
    def test_reproducibility(self):
        ...
        xx, yy = torch.meshgrid(
            torch.linspace(-1, 1, 50), torch.linspace(-1, 1, 50), indexing="ij"
        )

        result1 = gabor_texture(
            xx, yy, wavelength=0.4, orientation=math.pi / 3, sigma=0.5
        )
