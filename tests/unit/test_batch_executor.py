...
class TestBatchExecutor:
    ...
    def test_initialization_with_valid_config(
        self, minimal_batch_config, temp_output_dir
    ):
    ...
    def test_parameter_sweep_with_single_values(
        self, minimal_batch_config, temp_output_dir
    ):
    ...
    def test_execute_single_stimulus(
        self, mock_pipeline_class, minimal_batch_config, temp_output_dir
    ):
        ...
        result = executor._execute_single_stimulus(
            stim_config, save_intermediates=False
        )
    ...
    @patch("sensoryforge.core.batch_executor.GeneralizedTactileEncodingPipeline")
    def test_execute_batch_pytorch_format(
        self, mock_pipeline_class, minimal_batch_config, temp_output_dir
    ):
    ...
    @patch("sensoryforge.core.batch_executor.GeneralizedTactileEncodingPipeline")
    def test_execute_batch_hdf5_format(
        self, mock_pipeline_class, minimal_batch_config, temp_output_dir
    ):
    ...
    def test_from_yaml_classmethod(
        self, minimal_batch_config, temp_output_dir, tmp_path
    ):
