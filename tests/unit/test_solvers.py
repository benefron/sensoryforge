...
class TestAdaptiveSolver:
    ...
    def test_adaptive_import_error(self):
        ...
        try:
            ...
            assert "torchdiffeq" in error_msg, "Error should mention required package"
            assert (
                "sensoryforge[solvers]" in error_msg
    ...
    def test_adaptive_from_config(self):
        ...
        config = {"method": "dopri5", "rtol": 1e-6, "atol": 1e-8, "dt": 0.1}
...
class TestSolverFactory:
    ...
    def test_get_solver_adaptive(self):
        ...
        config = {"type": "adaptive", "method": "dopri5", "rtol": 1e-6, "dt": 0.05}
...
class TestSolverAPI:
    ...
    def test_solver_consistency(self):
        ...
        trajectory = solver.integrate(
            linear_ode, initial_state, t_span=(0.0, 0.5), dt=0.1
        )

        # Compare results
        for i, manual_state in enumerate(states_manual):
            assert torch.allclose(
                trajectory[0, i, :], manual_state[0]
