...
class TestYAMLConfigAPI:
    ...
    def test_composite_grid_config_structure(self):
        ...
        # Add populations
        grid.add_population(name="sa1", density=75.0, arrangement="poisson")
    ...
    def test_yaml_round_trip_basic(self):
        ...
        config = {
            "metadata": {"version": "0.3.0", "created": "2026-02-09T12:00:00"},
            "grid": {
                "type": "standard",
                "rows": 40,
                "cols": 40,
            ...
            "stimulus": {
                ...
                "amplitude": 1.0,
                "spread": 0.3,
                "texture": {"subtype": "gabor", "wavelength": 0.5},
            },
            "simulation": {"device": "cpu", "solver": {"type": "euler"}},
        }
    ...
    def test_extended_stimuli_yaml_round_trip(self):
        ...
        config = {
            "stimulus": {
                ...
                "moving": {
                    "subtype": "circular",
                    "circular": {"center": [2.0, 3.0], "radius": 1.5, "num_steps": 100},
                },
            }
        }
