...
'''
    test_template = (
        ...
        '''(mirrors tests/contract/test_component_contracts.py)."""
...
def register() -> None:
    ...
    distribution is installed and its
...
_PLUGIN_TEST_TEMPLATE = (
    '''"""Contract test for {{class_name}}, generated '''
    '''by `sensoryforge new-component`.
