    ...
    def get_param_spec(cls) -> List[ParamSpec]:
        ...
        return [
            ParamSpec(
                ...
                max_val=1e-8,
                unit="A",
                tooltip="Subthreshold leak bias current (I_xi)",
            ),
            ParamSpec(
                "I_th",
                dtype="float",
                ...
                max_val=1e-6,
                unit="A",
                tooltip="Threshold-setting bias current",
            ),
            ParamSpec(
                "I_tau_ahp",
                dtype="float",
                ...
                max_val=1e-8,
                unit="A",
                tooltip="AHP decay bias current",
            ),
            ParamSpec(
                "I_th_ahp",
                dtype="float",
                ...
                max_val=1e-8,
                unit="A",
                tooltip="AHP increment injected on spike",
            ),
            ParamSpec(
                "I_tau_refractory",
                dtype="float",
                ...
                max_val=1e-6,
                unit="A",
                tooltip="Refractory decay bias current",
            ),
            ParamSpec(
                "C_mem",
                dtype="float",
            ...
            ParamSpec(
                ...
                max_val=1e-11,
                unit="F",
                tooltip="Adaptation capacitance",
            ),
            ParamSpec(
                "C_refractory",
                dtype="float",
                ...
                max_val=1e-11,
                unit="F",
                tooltip="Refractory capacitance",
            ),
            ParamSpec(
                "U_T",
                dtype="float",
            ...
            ParamSpec(
                ...
                max_val=1.0,
                unit="",
                tooltip="Subthreshold slope factor",
            ),
            ParamSpec(
                "Ia_frac",
                dtype="float",
                ...
                max_val=0.999,
                unit="",
                tooltip="Intrinsic positive feedback fraction a = I_a/I_xi",
            ),
            ParamSpec(
                "dt",
                dtype="float",
            ...
            ParamSpec(
                ...
                max_val=1e-6,
                unit="A",
                tooltip="Reset value for z on spike",
            ),
            ParamSpec(
                "I_in_op",
                dtype="float",
                ...
                max_val=1e-6,
                unit="A",
                tooltip="Operating input current for z_th",
            ),
            ParamSpec(
                "current_scale",
                dtype="float",
            ...
            ParamSpec(
                ...
                max_val=1e-6,
                unit="A/sqrt(s)",
                tooltip="Additive Langevin noise on z",
            ),
        ]
